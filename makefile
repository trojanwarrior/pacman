...
CC=g++
CFLAGS=-c  -Wall -Wno-deprecated-declarations -Wno-unused-variable -I$(DIRHEA)  -I$(DIROGREBULLET_DIN) -I$(DIROGREBULLET_COL) -I$(DIROGREBULLET_DIN2) -I$(DIROGREBULLET_COL2) `pkg-config --cflags OGRE OGRE-Overlay MYGUI mxml bullet `  `sdl-config --cflags` --std=c++11
